...
@test value_at_risk(asset_returns, 0.05, :historical) ≈ -0.00115939244815142
@test value_at_risk(asset_returns, 0.05, :gaussian) ≈ -0.00114638483011466
@test value_at_risk(asset_returns, 0.05, :cornish_fisher) ≈ -0.00117095813580772

@test expected_shortfall(asset_returns, 0.05, :historical) ≈ -0.00164648648602694
